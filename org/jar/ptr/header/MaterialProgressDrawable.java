  ...
  private void setupAnimators() {
    ...
    Animation animation1 = new Animation() {
        public void applyTransformation(float param1Float, Transformation param1Transformation) {
          ...
          ring.setRotation(f2 + (f1 - f4) * param1Float);
  ...
  private static class Ring {
    ...
    private void drawTriangle(Canvas param1Canvas, float param1Float1, float param1Float2, Rect param1Rect) {
      if (this.mShowArrow) {
        ...
        d3 = this.mRingCenterRadius;
        d2 = Math.sin(0.0D);
        d1 = param1Rect.exactCenterY();
        Double.isNaN(d1);
        float f4 = (float)(d3 * d2 + d1);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\ptr\header\MaterialProgressDrawable.class
