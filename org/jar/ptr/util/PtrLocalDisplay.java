...
public class PtrLocalDisplay {
  ...
  public static int designedDP2px(float paramFloat) {
    ...
    if (SCREEN_WIDTH_DP != 320)
      f = paramFloat * SCREEN_WIDTH_DP / 320.0F; 
    return dp2px(f);
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\pt\\util\PtrLocalDisplay.class
