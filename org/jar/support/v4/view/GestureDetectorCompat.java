...
public final class GestureDetectorCompat {
  ...
  static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      //   50: ifeq -> 62
      //   53: aload_1
      //   54: invokestatic getActionIndex : (Landroid/view/MotionEvent;)I
      //   57: istore #5
      //   59: goto -> 65
      //   62: iconst_m1
      //   63: istore #5
      //   65: aload_1
      //   66: invokestatic getPointerCount : (Landroid/view/MotionEvent;)I
      //   69: istore #6
      //   71: iconst_0
      //   72: istore #7
      //   74: fconst_0
      ...
      //   99: aload_1
      //   100: iload #7
      //   102: invokestatic getX : (Landroid/view/MotionEvent;I)F
      //   105: fadd
      //   106: fstore #8
      //   108: fload #9
      //   110: aload_1
      //   111: iload #7
      //   113: invokestatic getY : (Landroid/view/MotionEvent;I)F
      //   116: fadd
      //   117: fstore #9
      //   119: iinc #7, 1
      //   122: goto -> 80
      ...
      //   246: aload_1
      //   247: invokestatic getActionIndex : (Landroid/view/MotionEvent;)I
      //   250: istore #5
      //   252: aload_1
      //   253: iload #5
      //   255: invokestatic getPointerId : (Landroid/view/MotionEvent;I)I
      //   258: istore_2
      //   259: aload_0
      //   260: getfield mVelocityTracker : Landroid/view/VelocityTracker;
      //   263: iload_2
      //   264: invokestatic getXVelocity : (Landroid/view/VelocityTracker;I)F
      //   267: fstore #9
      //   269: aload_0
      //   270: getfield mVelocityTracker : Landroid/view/VelocityTracker;
      //   273: iload_2
      //   274: invokestatic getYVelocity : (Landroid/view/VelocityTracker;I)F
      //   277: fstore #8
      //   279: iconst_0
      //   280: istore_2
      //   281: iload #4
      ...
      //   300: aload_1
      //   301: iload_2
      //   302: invokestatic getPointerId : (Landroid/view/MotionEvent;I)I
      //   305: istore #7
      //   307: aload_0
      ...
      //   323: iload #7
      //   325: invokestatic getYVelocity : (Landroid/view/VelocityTracker;I)F
      //   328: fload #8
      //   330: fmul
      //   331: fadd
      //   332: fconst_0
      ...
      //   764: aload_1
      //   765: iconst_0
      //   766: invokestatic getPointerId : (Landroid/view/MotionEvent;I)I
      //   769: istore_2
      //   770: aload #14
      //   772: sipush #1000
      //   775: aload_0
      ...
      //   783: aload #14
      //   785: iload_2
      //   786: invokestatic getYVelocity : (Landroid/view/VelocityTracker;I)F
      //   789: fstore #9
      //   791: aload #14
      //   793: iload_2
      //   794: invokestatic getXVelocity : (Landroid/view/VelocityTracker;I)F
      //   797: fstore #8
      //   799: fload #9
      ...
      //   1028: iconst_3
      //   1029: getstatic org/jar/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT : I
      //   1032: i2l
      ...
      //   1137: getstatic org/jar/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase.TAP_TIMEOUT : I
      //   1140: i2l
      //   1141: ladd
      //   1142: getstatic org/jar/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase.LONGPRESS_TIMEOUT : I
      //   1145: i2l
      //   1146: ladd
      ...
      //   1163: getstatic org/jar/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase.TAP_TIMEOUT : I
      //   1166: i2l
      //   1167: ladd
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v4\view\GestureDetectorCompat.class
