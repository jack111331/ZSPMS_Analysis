...
public final class ViewPropertyAnimatorCompat {
  ...
  static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
    ...
    private void postStartMessage(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
      ...
      if (this.mStarterMap != null) {
        starter1 = (Starter)this.mStarterMap.get(param1View);
      } else {
        starter1 = null;
      } 
      Starter starter2 = starter1;
      if (starter1 == null) {
        starter2 = new Starter(param1ViewPropertyAnimatorCompat, param1View);
        if (this.mStarterMap == null)
          this.mStarterMap = new WeakHashMap<View, Runnable>(); 
        this.mStarterMap.put(param1View, starter2);
      } 
      param1View.removeCallbacks(starter2);
      param1View.post(starter2);
    }
    ...
    private void startAnimation(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
      ...
      ViewPropertyAnimatorCompat.access$102(param1ViewPropertyAnimatorCompat, null);
      ViewPropertyAnimatorCompat.access$002(param1ViewPropertyAnimatorCompat, null);
      if (runnable1 != null)
        runnable1.run(); 
      if (object != null) {
    ...
    public void withEndAction(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View, Runnable param1Runnable) {
      ViewPropertyAnimatorCompat.access$002(param1ViewPropertyAnimatorCompat, param1Runnable);
      postStartMessage(param1ViewPropertyAnimatorCompat, param1View);
    }
    ...
    public void withStartAction(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View, Runnable param1Runnable) {
      ViewPropertyAnimatorCompat.access$102(param1ViewPropertyAnimatorCompat, param1Runnable);
      postStartMessage(param1ViewPropertyAnimatorCompat, param1View);
    }
    ...
    class Starter implements Runnable {
      ...
      private Starter(ViewPropertyAnimatorCompat param2ViewPropertyAnimatorCompat, View param2View) {
  ...
  class Starter implements Runnable {
    ...
    private Starter(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
  ...
  static class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
    ...
    public void withLayer(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
      ViewPropertyAnimatorCompat.access$402(param1ViewPropertyAnimatorCompat, ViewCompat.getLayerType(param1View));
      ViewPropertyAnimatorCompatICS.setListener(param1View, new MyVpaListener(param1ViewPropertyAnimatorCompat));
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v4\view\ViewPropertyAnimatorCompat.class
