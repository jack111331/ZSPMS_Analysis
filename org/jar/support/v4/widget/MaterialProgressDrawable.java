...
import org.jar.support.v4.animation.FastOutSlowInInterpolator;
...
class MaterialProgressDrawable extends Drawable implements Animatable {
  ...
  private int evaluateColorChange(float paramFloat, int paramInt1, int paramInt2) {
    ...
    return j + (int)(((paramInt2 >> 24 & 0xFF) - j) * paramFloat) << 24 | paramInt1 + (int)(((paramInt2 >> 16 & 0xFF) - paramInt1) * paramFloat) << 16 | k + (int)(((paramInt2 >> 8 & 0xFF) - k) * paramFloat) << 8 | i + (int)(paramFloat * ((paramInt2 & 0xFF) - i));
  }
        ...
        public void applyTransformation(float param1Float, Transformation param1Transformation) {
          if (MaterialProgressDrawable.this.mFinishing) {
            ...
            if (param1Float <= 0.5F) {
              ...
              ring.setStartTrim(f3 + (0.8F - f1) * f);
            } 
            if (param1Float > 0.5F) {
              f3 = (param1Float - 0.5F) / 0.5F;
              f3 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f3);
              ring.setEndTrim(f2 + (0.8F - f1) * f3);
            } 
            ring.setRotation(f4 + 0.25F * param1Float);
            f4 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
            MaterialProgressDrawable.this.setRotation(param1Float * 216.0F + f4 * 1080.0F);
          } 
        }
      };
  ...
  private static class Ring {
    ...
    private void drawTriangle(Canvas param1Canvas, float param1Float1, float param1Float2, Rect param1Rect) {
      if (this.mShowArrow) {
        ...
        d2 = this.mRingCenterRadius;
        d1 = Math.sin(0.0D);
        d3 = param1Rect.exactCenterY();
        Double.isNaN(d3);
        float f4 = (float)(d2 * d1 + d3);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v4\widget\MaterialProgressDrawable.class
