...
class OpReorderer {
  ...
  void swapMoveRemove(List<AdapterHelper.UpdateOp> paramList, int paramInt1, AdapterHelper.UpdateOp paramUpdateOp1, int paramInt2, AdapterHelper.UpdateOp paramUpdateOp2) {
    ...
    //   189: pop
    //   190: aload_0
    //   191: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   194: aload #5
    //   196: invokeinterface recycleUpdateOp : (Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;)V
    //   201: return
    //   202: aload_3
    ...
    //   276: istore #6
    //   278: aload_0
    //   279: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   282: iconst_2
    //   283: aload_3
    ...
    //   296: isub
    //   297: aconst_null
    //   298: invokeinterface obtainUpdateOp : (IIILjava/lang/Object;)Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;
    //   303: astore #10
    //   305: aload #5
    //   307: aload_3
    ...
    //   343: pop
    //   344: aload_0
    //   345: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   348: aload_3
    //   349: invokeinterface recycleUpdateOp : (Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;)V
    //   354: return
    //   355: iload #7
    //   357: ifeq -> 472
    //   360: aload #10
  ...
  void swapMoveUpdate(List<AdapterHelper.UpdateOp> paramList, int paramInt1, AdapterHelper.UpdateOp paramUpdateOp1, int paramInt2, AdapterHelper.UpdateOp paramUpdateOp2) {
    ...
    //   68: aload_0
    //   69: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   72: iconst_4
    //   73: aload_3
    ...
    //   83: invokeinterface obtainUpdateOp : (IIILjava/lang/Object;)Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;
    //   88: astore #9
    //   90: goto -> 96
    //   93: aconst_null
    //   94: astore #9
    ...
    //   157: istore #7
    //   159: aload_0
    //   160: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   163: iconst_4
    //   164: aload_3
    ...
    //   177: invokeinterface obtainUpdateOp : (IIILjava/lang/Object;)Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;
    //   182: astore #8
    //   184: aload #5
    //   186: aload #5
    ...
    //   235: pop
    //   236: aload_0
    //   237: getfield mCallback : Lorg/jar/support/v7/widget/OpReorderer$Callback;
    //   240: aload #5
    //   242: invokeinterface recycleUpdateOp : (Lorg/jar/support/v7/widget/AdapterHelper$UpdateOp;)V
    //   247: aload #9
    //   249: ifnull -> 261
    //   252: aload_1
    //   253: iload_2
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v7\widget\OpReorderer.class
