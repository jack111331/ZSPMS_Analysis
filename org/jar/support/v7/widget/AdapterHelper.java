...
import org.jar.support.v4.util.Pools;
    ...
    if (paramUpdateOp.cmd != 1 && paramUpdateOp.cmd != 8) {
      ...
      for (m = 1; b2 < paramUpdateOp.itemCount; m = k) {
        ...
        if (k != 0) {
          ...
          UpdateOp updateOp = obtainUpdateOp(paramUpdateOp.cmd, i, m, paramUpdateOp.payload);
      ...
      recycleUpdateOp(paramUpdateOp);
      if (m > 0) {
        paramUpdateOp = obtainUpdateOp(paramUpdateOp.cmd, i, m, object);
  ...
  static class UpdateOp {
    ...
    public boolean equals(Object param1Object) {
      ...
      if (this.payload != null) {
        if (!this.payload.equals(((UpdateOp)param1Object).payload))
          return false; 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v7\widget\AdapterHelper.class
