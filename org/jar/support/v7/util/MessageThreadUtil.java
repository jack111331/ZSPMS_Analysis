...
import org.jar.support.v4.content.ParallelExecutorCompat;
...
class MessageThreadUtil<T> implements ThreadUtil<T> {
  ...
  static class MessageQueue {
    ...
    MessageThreadUtil.SyncQueueItem next() {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   6: astore_1
      //   7: aload_1
      //   8: ifnonnull -> 15
      //   11: aload_0
      ...
      //   14: areturn
      //   15: aload_0
      //   16: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   19: astore_1
      //   20: aload_0
      //   21: aload_0
      //   22: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   25: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   28: putfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   31: aload_0
      //   32: monitorexit
      //   33: aload_1
      //   34: areturn
    ...
    void removeMessages(int param1Int) {
      ...
      //   6: ifnull -> 43
      //   9: aload_0
      //   10: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   13: getfield what : I
      //   16: iload_1
      //   17: if_icmpne -> 43
      //   20: aload_0
      //   21: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   24: astore_2
      //   25: aload_0
      //   26: aload_0
      //   27: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   30: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   33: putfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   36: aload_2
      //   37: invokevirtual recycle : ()V
      //   40: goto -> 2
      //   43: aload_0
      //   44: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   47: ifnull -> 100
      //   50: aload_0
      //   51: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   54: astore_3
      //   55: aload_3
      //   56: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   59: astore_2
      //   60: aload_2
      //   61: ifnull -> 100
      //   64: aload_2
      //   65: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   68: astore #4
      //   70: aload_2
      //   71: getfield what : I
      //   74: iload_1
      ...
      //   78: aload_3
      //   79: aload #4
      //   81: invokestatic access$202 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   84: pop
      //   85: aload_2
    ...
    void sendMessage(MessageThreadUtil.SyncQueueItem param1SyncQueueItem) {
      ...
      //   9: aload_0
      //   10: aload_1
      //   11: putfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   14: aload_0
      //   15: monitorexit
      //   16: return
      //   17: aload_0
      //   18: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   21: astore_2
      //   22: aload_2
      //   23: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   26: ifnull -> 37
      //   29: aload_2
      //   30: invokestatic access$200 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   33: astore_2
      ...
      //   37: aload_2
      //   38: aload_1
      //   39: invokestatic access$202 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   42: pop
      //   43: aload_0
      //   44: monitorexit
      //   45: return
    ...
    void sendMessageAtFrontOfQueue(MessageThreadUtil.SyncQueueItem param1SyncQueueItem) {
      ...
      //   2: aload_1
      //   3: aload_0
      //   4: getfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   7: invokestatic access$202 : (Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;)Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   10: pop
      //   11: aload_0
      //   12: aload_1
      //   13: putfield mRoot : Lorg/jar/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   16: aload_0
      //   17: monitorexit
      //   18: return
      //   19: astore_1
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v\\util\MessageThreadUtil.class
