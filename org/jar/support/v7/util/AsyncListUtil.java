...
import org.jar.support.annotation.UiThread;
import org.jar.support.annotation.WorkerThread;
...
public class AsyncListUtil<T> {
  ...
  private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() {
      ...
      public void updateItemCount(int param1Int1, int param1Int2) {
        if (!isRequestedGeneration(param1Int1))
          return; 
        AsyncListUtil.access$002(AsyncListUtil.this, param1Int2);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v\\util\AsyncListUtil.class
