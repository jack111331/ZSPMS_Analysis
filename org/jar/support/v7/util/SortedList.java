...
public class SortedList<T> {
  ...
  public static class BatchedCallback<T2> extends Callback<T2> {
    ...
    public void onChanged(int param1Int1, int param1Int2) {
      if (this.mLastEventType == 3 && param1Int1 <= this.mLastEventPosition + this.mLastEventCount) {
        int i = param1Int1 + param1Int2;
        if (i >= this.mLastEventPosition) {
          param1Int2 = this.mLastEventPosition;
          int j = this.mLastEventCount;
          this.mLastEventPosition = Math.min(param1Int1, this.mLastEventPosition);
          this.mLastEventCount = Math.max(param1Int2 + j, i) - this.mLastEventPosition;
          return;
        } 
      } 
      dispatchLastEvent();
      this.mLastEventPosition = param1Int1;
      this.mLastEventCount = param1Int2;
      this.mLastEventType = 3;
    }
    
    public void onInserted(int param1Int1, int param1Int2) {
      if (this.mLastEventType == 1 && param1Int1 >= this.mLastEventPosition && param1Int1 <= this.mLastEventPosition + this.mLastEventCount) {
        this.mLastEventCount += param1Int2;
        this.mLastEventPosition = Math.min(param1Int1, this.mLastEventPosition);
        return;
      } 
    ...
    public void onMoved(int param1Int1, int param1Int2) {
      dispatchLastEvent();
      this.mWrappedCallback.onMoved(param1Int1, param1Int2);
    }
    
    public void onRemoved(int param1Int1, int param1Int2) {
      if (this.mLastEventType == 2 && this.mLastEventPosition == param1Int1) {
        this.mLastEventCount += param1Int2;
        return;
      } 
      dispatchLastEvent();
  ...
  public static abstract class Callback<T2> implements Comparator<T2> {
    ...
    public abstract void onInserted(int param1Int1, int param1Int2);
    
    public abstract void onMoved(int param1Int1, int param1Int2);
    
    public abstract void onRemoved(int param1Int1, int param1Int2);
  }
}


/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\org\jar\support\v\\util\SortedList.class
