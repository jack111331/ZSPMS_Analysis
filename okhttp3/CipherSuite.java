...
public enum CipherSuite {
  ...
  public static CipherSuite forJavaName(String paramString) {
    return paramString.startsWith("SSL_") ? valueOf("TLS_" + paramString.substring(4)) : valueOf(paramString);
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\CipherSuite.class
