...
public final class Handshake {
  ...
  public int hashCode() {
    if (this.tlsVersion != null) {
      int i = this.tlsVersion.hashCode();
      return (((i + 527) * 31 + this.cipherSuite.hashCode()) * 31 + this.peerCertificates.hashCode()) * 31 + this.localCertificates.hashCode();
    } 
    byte b = 0;
    return (((b + 527) * 31 + this.cipherSuite.hashCode()) * 31 + this.peerCertificates.hashCode()) * 31 + this.localCertificates.hashCode();
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\Handshake.class
