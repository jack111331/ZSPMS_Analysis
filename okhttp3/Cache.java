  ...
  public Iterator<String> urls() throws IOException {
    return new Iterator<String>() {
        ...
        public boolean hasNext() {
          ...
          //   37: checkcast okhttp3/internal/DiskLruCache$Snapshot
          //   40: astore_2
          //   41: aload_0
          //   42: aload_2
          //   43: iconst_0
  ...
  private static final class Entry {
    ...
    public Entry(Source param1Source) throws IOException {
      try {
        ...
        String str1 = builder2.get(OkHeaders.SENT_MILLIS);
    ...
    private List<Certificate> readCertificateList(BufferedSource param1BufferedSource) throws IOException {
      ...
      try {
        ...
        while (true) {
          ...
          return (List<Certificate>)buffer;
        } 
    ...
    public boolean matches(Request param1Request, Response param1Response) {
      return (this.url.equals(param1Request.url().toString()) && this.requestMethod.equals(param1Request.method()) && OkHeaders.varyMatches(param1Response, this.varyHeaders, param1Request));
    }
    ...
    public void writeTo(DiskLruCache.Editor param1Editor) throws IOException {
      ...
      bufferedSink.writeUtf8(OkHeaders.SENT_MILLIS).writeUtf8(": ").writeDecimalLong(this.sentRequestMillis).writeByte(10);
      bufferedSink.writeUtf8(OkHeaders.RECEIVED_MILLIS).writeUtf8(": ").writeDecimalLong(this.receivedResponseMillis).writeByte(10);
      if (isHttps()) {
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\Cache.class
