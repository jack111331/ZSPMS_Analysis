  ...
  private static List<String> getSubjectAltNames(X509Certificate paramX509Certificate, int paramInt) {
    ...
    try {
      ...
      while (true) {
        ...
        if (iterator.hasNext()) {
          List<Integer> list1 = (List)iterator.next();
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\internal\tls\OkHostnameVerifier.class
