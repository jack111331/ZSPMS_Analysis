...
class JdkWithJettyBootPlatform extends Platform {
  ...
  public static Platform buildIfSupported() {
    try {
      ...
      Method method1 = clazz1.getMethod("put", new Class[] { SSLSocket.class, clazz3 });
      ...
      this(method1, method2, method3, clazz2, clazz4);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\internal\JdkWithJettyBootPlatform.class
