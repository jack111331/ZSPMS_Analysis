...
public final class Headers {
  ...
  public static Headers of(Map<String, String> paramMap) {
    ...
    for (Map.Entry<String, String> entry : paramMap.entrySet()) {
      ...
      String str2 = ((String)entry.getKey()).trim();
      String str1 = ((String)entry.getValue()).trim();
      if (str2.length() == 0 || str2.indexOf(false) != -1 || str1.indexOf(false) != -1)
        throw new IllegalArgumentException("Unexpected header: " + str2 + ": " + str1); 
  ...
  public static Headers of(String... paramVarArgs) {
    ...
    for (b = 0; b < paramVarArgs.length; b++) {
      if (paramVarArgs[b] == null)
        throw new IllegalArgumentException("Headers cannot be null"); 
      paramVarArgs[b] = paramVarArgs[b].trim();
    } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\Headers.class
