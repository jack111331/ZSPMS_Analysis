...
public final class MultipartBody extends RequestBody {
  ...
  private long writeOrCountBytes(BufferedSink paramBufferedSink, boolean paramBoolean) throws IOException {
    ...
    while (b < i) {
      ...
      if (l1 != -1L) {
        buffer1.writeUtf8("Content-Length: ").writeDecimalLong(l1).write(CRLF);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\okhttp3\MultipartBody.class
