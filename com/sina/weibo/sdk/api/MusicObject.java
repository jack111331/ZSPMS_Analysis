...
public class MusicObject extends BaseMediaObject {
  public static final Parcelable.Creator<MusicObject> CREATOR = new Parcelable.Creator<MusicObject>() {
      public MusicObject createFromParcel(Parcel param1Parcel) {
        return new MusicObject(param1Parcel);
      }
      
      public MusicObject[] newArray(int param1Int) {
        return new MusicObject[param1Int];
      }
    };
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\sina\weibo\sdk\api\MusicObject.class
