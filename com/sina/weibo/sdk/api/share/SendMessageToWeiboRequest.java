...
public class SendMessageToWeiboRequest extends BaseRequest {
  ...
  final boolean check(Context paramContext, WeiboAppManager.WeiboInfo paramWeiboInfo, VersionCheckHandler paramVersionCheckHandler) {
    return (this.message == null || paramWeiboInfo == null || !paramWeiboInfo.isLegal()) ? false : ((paramVersionCheckHandler != null && !paramVersionCheckHandler.checkRequest(paramContext, paramWeiboInfo, this.message)) ? false : this.message.checkArgs());
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\sina\weibo\sdk\api\share\SendMessageToWeiboRequest.class
