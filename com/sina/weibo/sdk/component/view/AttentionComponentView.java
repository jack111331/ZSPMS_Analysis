...
public class AttentionComponentView extends FrameLayout {
    ...
    NetUtils.internalHttpRequest(getContext(), "https://api.weibo.com/2/friendships/show.json", weiboParameters, "GET", new RequestListener() {
          public void onComplete(String param1String) {
            ...
            try {
              ...
              this(param1String);
              JSONObject jSONObject2 = jSONObject1.optJSONObject("target");
              Handler handler = AttentionComponentView.this.getHandler();
  ...
  private void showFollowButton(boolean paramBoolean) {
    ...
    if (paramBoolean) {
      ...
      Drawable drawable = ResourceManager.getDrawable(getContext(), "timeline_relationship_icon_attention.png");
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\sina\weibo\sdk\component\view\AttentionComponentView.class
