...
public class SsoHandler {
  ...
  private boolean startSingleSignOn(String paramString1, String paramString2) {
    ...
    boolean bool = SecurityHelper.validateAppSignatureForIntent((Context)this.mAuthActivity, intent);
    boolean bool1 = false;
    if (!bool)
      return false; 
  ...
  public void authorizeCallBack(int paramInt1, int paramInt2, Intent paramIntent) {
    ...
    if (paramInt1 == this.mSSOAuthRequestCode) {
      ...
      if (paramInt2 == -1) {
        ...
        Oauth2AccessToken oauth2AccessToken = Oauth2AccessToken.parseAccessToken(bundle1);
        if (oauth2AccessToken != null && oauth2AccessToken.isSessionValid()) {
          stringBuilder1 = new StringBuilder("Login Success! ");
          stringBuilder1.append(oauth2AccessToken.toString());
          LogUtil.d("Weibo_SSO_login", stringBuilder1.toString());
          this.mAuthListener.onComplete(bundle1);
        } 
      } else if (paramInt2 == 0) {
        if (stringBuilder1 != null) {
          stringBuilder = new StringBuilder("Login failed: ");
          stringBuilder.append(stringBuilder1.getStringExtra("error"));
          LogUtil.d("Weibo_SSO_login", stringBuilder.toString());
          String str2 = stringBuilder1.getStringExtra("error");
          String str1 = str2;
          if (str2 == null)
            str1 = stringBuilder1.getStringExtra("error_type"); 
          if (str1 != null)
            this.mAuthListener.onWeiboException((WeiboException)new WeiboDialogException(stringBuilder1.getStringExtra("error"), stringBuilder1.getIntExtra("error_code", -1), stringBuilder1.getStringExtra("error_description"))); 
        } else {
          LogUtil.d("Weibo_SSO_login", "Login canceled by user.");
          this.mAuthListener.onCancel();
        } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\sina\weibo\sdk\auth\sso\SsoHandler.class
