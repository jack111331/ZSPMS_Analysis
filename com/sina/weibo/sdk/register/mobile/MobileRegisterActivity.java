...
public class MobileRegisterActivity extends Activity implements View.OnClickListener, View.OnFocusChangeListener, ResizeableLayout.SizeChangeListener {
  ...
  private TextView genProtocalInfoTv() {
    ...
    if (Locale.SIMPLIFIED_CHINESE.equals(locale)) {
      ...
      i = "点击“确定”表示你同意服务使用协议和隐私条款。".indexOf("服务使用协议");
      j = "服务使用协议".length() + i;
      k = "点击“确定”表示你同意服务使用协议和隐私条款。".indexOf("隐私条款");
      m = "隐私条款".length() + k;
    } else if (Locale.TRADITIONAL_CHINESE.equals(str2)) {
      str2 = "點擊“確定”標示你同意服務使用協議和隱私條款。";
      str1 = "zh_HK";
      i = "點擊“確定”標示你同意服務使用協議和隱私條款。".indexOf("服務使用協議");
      j = "服務使用協議".length() + i;
      k = "點擊“確定”標示你同意服務使用協議和隱私條款。".indexOf("隱私條款");
      m = "隱私條款".length() + k;
    } else {
      str2 = "By clicking ok, you hereby agree to Weibo Online Service Agreement and Privacy Policy";
      str1 = "en_US";
      i = "By clicking ok, you hereby agree to Weibo Online Service Agreement and Privacy Policy".indexOf("Service Agreement");
      j = "Service Agreement".length() + i;
      k = "By clicking ok, you hereby agree to Weibo Online Service Agreement and Privacy Policy".indexOf("Privacy Policy");
      m = "Privacy Policy".length() + k;
    } 
    ...
    if (i != -1 && j != -1) {
      ...
      spannableStringBuilder.setSpan(new WBSdkUrlClickSpan((Context)this, stringBuilder.toString()), i, j, 33);
    } 
    if (k != -1 && m != -1) {
      StringBuilder stringBuilder = new StringBuilder("http://m.weibo.cn/reg/privacyagreement?from=h5&wm=3349&lang=");
      stringBuilder.append(str1);
      spannableStringBuilder.setSpan(new WBSdkUrlClickSpan((Context)this, stringBuilder.toString()), k, m, 33);
    } 
  ...
  private void initView() {
    ...
    layoutParams6.topMargin = ResourceManager.dp2px((Context)this, 47);
    this.mRegistScrollview.setBackgroundColor(-855310);
    this.mRegistScrollview.setLayoutParams((ViewGroup.LayoutParams)layoutParams6);
    this.mRegiter_llt = new LinearLayout((Context)this);
    LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(-1, -2);
    this.mRegiter_llt.setOrientation(1);
    this.mRegiter_llt.setLayoutParams((ViewGroup.LayoutParams)layoutParams5);
    ...
    RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(-1, ResourceManager.dp2px((Context)this, 48));
    ...
    this.mCountryLayout.setLayoutParams((ViewGroup.LayoutParams)layoutParams4);
    ...
    layoutParams4 = new RelativeLayout.LayoutParams(-2, ResourceManager.dp2px((Context)this, 48));
    layoutParams4.leftMargin = ResourceManager.dp2px((Context)this, 15);
    layoutParams4.addRule(9);
    this.mCountryCode.setLayoutParams((ViewGroup.LayoutParams)layoutParams4);
    ...
    RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(ResourceManager.dp2px((Context)this, 13), ResourceManager.dp2px((Context)this, 13));
    layoutParams2.rightMargin = ResourceManager.dp2px((Context)this, 15);
    ...
    layoutParams2.rightMargin = ResourceManager.dp2px((Context)this, 118);
    layoutParams2.addRule(0, 2);
    layoutParams2.addRule(15);
    this.mCountryName.setLayoutParams((ViewGroup.LayoutParams)layoutParams2);
    ...
    this.mTips.setText("");
    this.mTips.setVisibility(4);
    LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(-1, ResourceManager.dp2px((Context)this, 36));
    layoutParams3.leftMargin = ResourceManager.dp2px((Context)this, 12);
    this.mTips.setGravity(16);
    this.mTips.setLayoutParams((ViewGroup.LayoutParams)layoutParams3);
    this.mRegiter_llt.addView((View)this.mTips);
    this.mBtnRegist = genOKBtn();
    disableRegisterBtn();
    this.mRegiter_llt.addView((View)this.mBtnRegist);
    TextView textView2 = genSinaServiceTv();
    TextView textView1 = genProtocalInfoTv();
  ...
  public void getMsg(String paramString1, String paramString2) {
    ...
    NetUtils.internalHttpRequest((Context)this, "http://api.weibo.com/oauth2/sms_authorize/send", weiboParameters, "GET", new RequestListener() {
          ...
          public void onWeiboException(WeiboException param1WeiboException) {
            // Byte code:
            //   0: invokestatic access$9 : ()Ljava/lang/String;
            //   3: astore_2
            //   4: new java/lang/StringBuilder
            //   7: dup
            //   8: ldc 'get onWeiboException '
            ...
            //   31: aload_0
            //   32: getfield this$0 : Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;
            //   35: invokevirtual getApplicationContext : ()Landroid/content/Context;
            //   38: ldc 'the server is busy, please  wait'
            //   40: ldc '服务器忙,请稍后再试'
            //   42: ldc '服務器忙,請稍後再試'
            //   44: invokestatic getString : (Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
            //   47: astore_2
            ...
            //   88: astore_1
            //   89: aload_0
            //   90: getfield this$0 : Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;
            //   93: invokevirtual getApplicationContext : ()Landroid/content/Context;
            //   96: aload_1
            //   97: iconst_1
            //   98: invokestatic showToast : (Landroid/content/Context;Ljava/lang/CharSequence;I)V
            //   101: return
            // Exception table:
            //   from	to	target	type
            //   48	79	82	java/lang/Exception
          }
        });
  }
  ...
  public void onClick(View paramView) {
    ...
    } else if (str == this.mPhoneNumClearBtn) {
      this.mPhoneNum.setText("");
    } else if (str == this.mBtnRegist) {
      String str1 = this.mPhoneNum.getText().toString();
      str = this.mCheckCode.getText().toString();
      if (doCheckOnSubmit(str))
        submit(str1, str); 
  ...
  public void submit(final String phoneNum, String paramString2) {
    ...
    NetUtils.internalHttpRequest((Context)this, "http://api.weibo.com/oauth2/sms_authorize/submit", weiboParameters, "GET", new RequestListener() {
          ...
          public void onWeiboException(WeiboException param1WeiboException) {
            ...
            //   89: aload_0
            //   90: getfield this$0 : Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;
            //   93: invokestatic access$11 : (Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;)Landroid/widget/TextView;
            //   96: iconst_0
            //   97: invokevirtual setVisibility : (I)V
            //   100: aload_0
            //   101: getfield this$0 : Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;
            //   104: invokestatic access$11 : (Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;)Landroid/widget/TextView;
            //   107: aload_1
            //   108: invokevirtual setText : (Ljava/lang/CharSequence;)V
            //   111: aload_0
            //   112: getfield this$0 : Lcom/sina/weibo/sdk/register/mobile/MobileRegisterActivity;
            //   115: invokevirtual dismiss : ()V
            //   118: return
            // Exception table:
            //   from	to	target	type
            //   48	79	82	java/lang/Exception
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\sina\weibo\sdk\register\mobile\MobileRegisterActivity.class
