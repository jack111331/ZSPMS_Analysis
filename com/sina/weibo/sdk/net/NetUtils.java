...
public class NetUtils {
  public static String internalDownloadFile(Context paramContext, String paramString1, String paramString2, String paramString3) throws WeiboException {
  ...
  public static void internalHttpRequest(Context paramContext, String paramString1, WeiboParameters paramWeiboParameters, String paramString2, RequestListener paramRequestListener) {
    (new AsyncWeiboRunner.RequestRunner(paramContext, paramString1, paramWeiboParameters, paramString2, paramRequestListener)).execute((Object[])new Void[1]);
  }
}
