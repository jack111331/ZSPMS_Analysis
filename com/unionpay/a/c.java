...
public final class c {
  ...
  public final int a() {
    ...
    if (this.f.d() != null)
      ((HttpPost)httpGet).setEntity((HttpEntity)new ByteArrayEntity(this.f.d())); 
    ...
    try {
      ...
      if (this.b.getStatusLine().getStatusCode() == 200) {
        ...
        if (this.b.getStatusLine().getStatusCode() == 401) {
          ...
          h.b("uppay", stringBuilder.append(this.b.getStatusLine().getStatusCode()).toString());
          i = 1;
        } 
        h.a("uppay", "HttpConn.connect() ---");
      } 
      ...
      h.a("uppay", "e0:" + sSLHandshakeException.getMessage());
      i = 4;
    ...
    if (this.d != null) {
      try {
        ...
        try {
          StringBuilder stringBuilder = new StringBuilder();
          this("respon:");
          h.a("uppay", stringBuilder.append(str).toString());
          return str;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\co\\unionpay\a\c.class
