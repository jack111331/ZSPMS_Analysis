...
final class Utils {
  ...
  static long calculateDiskCacheSize(File paramFile) {
    ...
    try {
      ...
      l2 = statFs.getBlockCount() * statFs.getBlockSize() / 50L;
    } catch (IllegalArgumentException illegalArgumentException) {
      l2 = l1;
    } 
    return Math.max(Math.min(l2, 52428800L), 5242880L);
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\squareup\picasso\Utils.class
