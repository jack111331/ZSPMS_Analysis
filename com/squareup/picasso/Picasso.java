      ...
      public void handleMessage(Message param1Message) {
        ...
        switch (param1Message.what) {
          ...
          case 8:
            ...
            i = list1.size();
            while (b < i) {
              bitmapHunter = list1.get(b);
              bitmapHunter.picasso.complete(bitmapHunter);
              b++;
            } 
            return;
          case 3:
            action = (Action)((Message)bitmapHunter).obj;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\squareup\picasso\Picasso.class
