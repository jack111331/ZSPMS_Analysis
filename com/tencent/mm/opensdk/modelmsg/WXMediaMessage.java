...
public final class WXMediaMessage {
  ...
  final boolean checkArgs() {
    if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
      String str = "checkArgs fail, thumbData should not be null when send emoji";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
    if (this.thumbData != null && this.thumbData.length > 32768) {
      String str = "checkArgs fail, thumbData is invalid";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
    if (this.title != null && this.title.length() > 512) {
      String str = "checkArgs fail, title is invalid";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
    if (this.description != null && this.description.length() > 1024) {
      String str = "checkArgs fail, description is invalid";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
    if (this.mediaObject == null) {
      String str = "checkArgs fail, mediaObject is null";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
    if (this.mediaTagName != null && this.mediaTagName.length() > 64) {
      String str = "checkArgs fail, mediaTagName is too long";
      Log.e("MicroMsg.SDK.WXMediaMessage", str);
      return false;
    } 
  ...
  public static class Builder {
    ...
    private static String pathOldToNew(String param1String) {
      ...
      return param1String.replace("com.tencent.mm.sdk.openapi", "com.tencent.mm.opensdk.modelmsg");
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\tencent\mm\opensdk\modelmsg\WXMediaMessage.class
