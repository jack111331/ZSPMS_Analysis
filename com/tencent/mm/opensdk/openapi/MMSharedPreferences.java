...
class MMSharedPreferences implements SharedPreferences {
  ...
  private Object getValue(String paramString) {
    try {
      Cursor cursor = this.cr.query(c.b.CONTENT_URI, this.columns, "key = ?", new String[] { paramString }, null);
      if (cursor == null)
        return null; 
      int i = cursor.getColumnIndex("type");
      int j = cursor.getColumnIndex("value");
      if (cursor.moveToFirst()) {
        Object object = c.a.a(cursor.getInt(i), cursor.getString(j));
      } else {
        paramString = null;
      } 
      cursor.close();
  ...
  public Map<String, ?> getAll() {
    try {
      ...
      while (cursor.moveToNext()) {
        Object object = c.a.a(cursor.getInt(j), cursor.getString(k));
  ...
  public boolean getBoolean(String paramString, boolean paramBoolean) {
    ...
    return (object != null && object instanceof Boolean) ? ((Boolean)object).booleanValue() : paramBoolean;
  }
  
  public float getFloat(String paramString, float paramFloat) {
    Object object = getValue(paramString);
    return (object != null && object instanceof Float) ? ((Float)object).floatValue() : paramFloat;
  }
  
  public int getInt(String paramString, int paramInt) {
    Object object = getValue(paramString);
    return (object != null && object instanceof Integer) ? ((Integer)object).intValue() : paramInt;
  }
  
  public long getLong(String paramString, long paramLong) {
    Object object = getValue(paramString);
    return (object != null && object instanceof Long) ? ((Long)object).longValue() : paramLong;
  }
  
  public String getString(String paramString1, String paramString2) {
    Object object = getValue(paramString1);
    return (object != null && object instanceof String) ? (String)object : paramString2;
  }
        ...
        if (iterator.hasNext()) {
          ...
          if (object == null) {
            ...
            if (object instanceof Integer) {
              ...
              StringBuilder stringBuilder = new StringBuilder("unresolve failed, unknown type=");
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\tencent\mm\opensdk\openapi\MMSharedPreferences.class
