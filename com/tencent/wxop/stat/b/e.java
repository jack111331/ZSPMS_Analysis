  ...
  final void a(JSONObject paramJSONObject, Thread paramThread) {
    ...
    if (paramThread == null) {
      ...
      if (g.r(this.cB).W()) {
        ...
        r.a(jSONObject, "bs", r.U(this.cB));
        r.a(jSONObject, "ss", r.V(this.cB));
        if (jSONObject.length() > 0)
          r.a(paramJSONObject, "wf", jSONObject.toString()); 
      } 
      jSONArray = r.X(this.cB);
      if (jSONArray != null && jSONArray.length() > 0)
        r.a(paramJSONObject, "wflist", jSONArray.toString()); 
      r.a(paramJSONObject, "sen", this.cC);
    } else {
      r.a(paramJSONObject, "thn", jSONArray.getName());
      r.a(paramJSONObject, "qq", c.f(this.cB));
      r.a(paramJSONObject, "cui", c.g(this.cB));
      ...
      r.a(paramJSONObject, "mid", c.h(this.cB));
    } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\tencent\wxop\stat\b\e.class
