    ...
    if (handler != null) {
      if (!StringUtils.isBlank(paramString2)) {
        if (!StringUtils.isBlank(paramString1)) {
          ...
          this.client.asyncPost(url(paramString1), arrayOfByte, stringMap, null, arrayOfByte.length, null, new CompletionHandler() {
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\qiniu\android\bigdata\pipeline\Pipeline.class
