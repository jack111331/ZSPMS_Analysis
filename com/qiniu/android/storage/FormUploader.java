...
final class FormUploader {
  private static void post(byte[] paramArrayOfbyte, File paramFile, final String key, final UpToken token, final UpCompletionHandler completionHandler, final UploadOptions options, final Client client, final Configuration config) {
    long l2;
    ...
    if (paramFile != null) {
      try {
        l2 = Crc32.file(paramFile);
      } catch (IOException iOException) {
        iOException.printStackTrace();
        l2 = l1;
      } 
    } else {
      l2 = Crc32.bytes(paramArrayOfbyte);
    } 
    ...
    client.asyncMultipartPost(str, postArgs, token, progressHandler, new CompletionHandler() {
                    ...
                    public void complete(ResponseInfo param2ResponseInfo, JSONObject param2JSONObject) {
                      if (param2ResponseInfo.isOK()) {
                        ...
                        if (param2ResponseInfo.needRetry()) {
                          ...
                          client.asyncMultipartPost(str, args, token, progress, completionHandler, options.cancellationSignal);
                        } else {
  ...
  public static ResponseInfo syncUpload(Client paramClient, Configuration paramConfiguration, File paramFile, String paramString, UpToken paramUpToken, UploadOptions paramUploadOptions) {
    try {
      return syncUpload0(paramClient, paramConfiguration, null, paramFile, paramString, paramUpToken, paramUploadOptions);
      ...
      return ResponseInfo.create(null, 0, "", "", "", "", "", "", 0, 0L, 0L, str, paramUpToken, l);
    } 
  }
  ...
  public static ResponseInfo syncUpload(Client paramClient, Configuration paramConfiguration, byte[] paramArrayOfbyte, String paramString, UpToken paramUpToken, UploadOptions paramUploadOptions) {
    try {
      return syncUpload0(paramClient, paramConfiguration, paramArrayOfbyte, null, paramString, paramUpToken, paramUploadOptions);
    } catch (Exception exception) {
      long l;
      String str = exception.getMessage();
  ...
  private static ResponseInfo syncUpload0(Client paramClient, Configuration paramConfiguration, byte[] paramArrayOfbyte, File paramFile, String paramString, UpToken paramUpToken, UploadOptions paramUploadOptions) {
    StringMap stringMap = new StringMap();
    ...
    postArgs.params = stringMap;
    if (!paramConfiguration.zone.preQuery(paramUpToken.token))
    ...
    stringBuilder1.append(str);
    Log.d("Qiniu.FormUploader", stringBuilder1.toString());
    ResponseInfo responseInfo2 = paramClient.syncMultipartPost(str, postArgs, paramUpToken);
    ...
    if (responseInfo2.needRetry()) {
      ...
      str = paramConfiguration.zone.upHost(paramUpToken.token, paramConfiguration.useHttps, str);
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder.append("sync upload retry first time use up host ");
      stringBuilder.append(str);
      Log.d("Qiniu.FormUploader", stringBuilder.toString());
      responseInfo2 = paramClient.syncMultipartPost(str, postArgs, paramUpToken);
      ...
      if (responseInfo2.needRetry()) {
        ...
        String str1 = paramConfiguration.zone.upHost(paramUpToken.token, paramConfiguration.useHttps, str);
        ...
        ResponseInfo responseInfo3 = paramClient.syncMultipartPost(str1, postArgs, paramUpToken);
  ...
  static void upload(Client paramClient, Configuration paramConfiguration, File paramFile, String paramString, UpToken paramUpToken, UpCompletionHandler paramUpCompletionHandler, UploadOptions paramUploadOptions) {
    post(null, paramFile, paramString, paramUpToken, paramUpCompletionHandler, paramUploadOptions, paramClient, paramConfiguration);
  }
  ...
  static void upload(Client paramClient, Configuration paramConfiguration, byte[] paramArrayOfbyte, String paramString, UpToken paramUpToken, UpCompletionHandler paramUpCompletionHandler, UploadOptions paramUploadOptions) {
    post(paramArrayOfbyte, null, paramString, paramUpToken, paramUpCompletionHandler, paramUploadOptions, paramClient, paramConfiguration);
  }
}


/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\qiniu\android\storage\FormUploader.class
