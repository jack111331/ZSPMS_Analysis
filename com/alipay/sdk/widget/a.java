...
public final class a {
  ...
  public final class a extends AlertDialog {
    ...
    private static int a(Context param1Context, float param1Float) {
      if (param1Context == null) {
        resources = Resources.getSystem();
        return (int)((resources.getDisplayMetrics()).density * param1Float);
      } 
      Resources resources = resources.getResources();
      return (int)((resources.getDisplayMetrics()).density * param1Float);
    }
    
    private static Drawable a(Context param1Context, String param1String) {
      try {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream();
        this(com.alipay.sdk.encrypt.a.a(param1String));
    ...
    private View a(Context param1Context) {
      ...
      imageView.setImageDrawable(a(param1Context, a.d));
      ...
      if (TextUtils.isEmpty(a.b(this.a))) {
        ...
        layoutParams3.setMargins(0, 0, a(param1Context, 17.0F), 0);
    ...
    protected final void onCreate(Bundle param1Bundle) {
      String str;
      ...
      LinearLayout.LayoutParams layoutParams1 = new LinearLayout.LayoutParams(-2, -2);
      layoutParams1.gravity = 16;
      layoutParams1.setMargins(0, 0, a(context, 17.0F), 0);
      textView.setLayoutParams((ViewGroup.LayoutParams)layoutParams1);
      linearLayout.addView((View)imageView);
      linearLayout.addView((View)textView);
      setContentView((View)linearLayout);
      getWindow().setBackgroundDrawable((Drawable)new ColorDrawable(17170445));
    }
  }
}


/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\alipay\sdk\widget\a.class
