...
public final class ExpandedProductParsedResult extends ParsedResult {
  ...
  public boolean equals(Object paramObject) {
    ...
    return (equalsOrNull(this.productID, ((ExpandedProductParsedResult)paramObject).productID) && equalsOrNull(this.sscc, ((ExpandedProductParsedResult)paramObject).sscc) && equalsOrNull(this.lotNumber, ((ExpandedProductParsedResult)paramObject).lotNumber) && equalsOrNull(this.productionDate, ((ExpandedProductParsedResult)paramObject).productionDate) && equalsOrNull(this.bestBeforeDate, ((ExpandedProductParsedResult)paramObject).bestBeforeDate) && equalsOrNull(this.expirationDate, ((ExpandedProductParsedResult)paramObject).expirationDate) && equalsOrNull(this.weight, ((ExpandedProductParsedResult)paramObject).weight) && equalsOrNull(this.weightType, ((ExpandedProductParsedResult)paramObject).weightType) && equalsOrNull(this.weightIncrement, ((ExpandedProductParsedResult)paramObject).weightIncrement) && equalsOrNull(this.price, ((ExpandedProductParsedResult)paramObject).price) && equalsOrNull(this.priceIncrement, ((ExpandedProductParsedResult)paramObject).priceIncrement) && equalsOrNull(this.priceCurrency, ((ExpandedProductParsedResult)paramObject).priceCurrency) && equalsOrNull(this.uncommonAIs, ((ExpandedProductParsedResult)paramObject).uncommonAIs));
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\zxing\client\result\ExpandedProductParsedResult.class
