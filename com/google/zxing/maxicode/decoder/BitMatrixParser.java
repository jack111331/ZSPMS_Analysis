...
final class BitMatrixParser {
  private static final int[][] BITNR = new int[][] { 
      { 
  ...
  byte[] readCodewords() {
    ...
    int j = this.bitMatrix.getWidth();
    for (byte b = 0; b < i; b++) {
      int[] arrayOfInt = BITNR[b];
      for (byte b1 = 0; b1 < j; b1++) {
        int k = arrayOfInt[b1];
        if (k >= 0 && this.bitMatrix.get(b1, b)) {
          int m = k / 6;
          byte b2 = arrayOfByte[m];
          arrayOfByte[m] = (byte)(byte)((byte)(1 << 5 - k % 6) | b2);
        } 
      } 
    } 
    return arrayOfByte;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\zxing\maxicode\decoder\BitMatrixParser.class
