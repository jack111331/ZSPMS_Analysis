...
public final class GenericGF {
  ...
  public GenericGF(int paramInt1, int paramInt2, int paramInt3) {
    ...
    paramInt3 = 1;
    while (b < paramInt2) {
      this.expTable[b] = paramInt3;
      int i = paramInt3 << 1;
      paramInt3 = i;
      if (i >= paramInt2)
        paramInt3 = (i ^ paramInt1) & paramInt2 - 1; 
      b++;
    } 
  ...
  int multiply(int paramInt1, int paramInt2) {
    return (paramInt1 == 0 || paramInt2 == 0) ? 0 : this.expTable[(this.logTable[paramInt1] + this.logTable[paramInt2]) % (this.size - 1)];
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\zxing\common\reedsolomon\GenericGF.class
