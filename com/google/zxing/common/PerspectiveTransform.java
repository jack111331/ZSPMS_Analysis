...
public final class PerspectiveTransform {
  ...
  public static PerspectiveTransform quadrilateralToQuadrilateral(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8, float paramFloat9, float paramFloat10, float paramFloat11, float paramFloat12, float paramFloat13, float paramFloat14, float paramFloat15, float paramFloat16) {
    PerspectiveTransform perspectiveTransform = quadrilateralToSquare(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6, paramFloat7, paramFloat8);
    return squareToQuadrilateral(paramFloat9, paramFloat10, paramFloat11, paramFloat12, paramFloat13, paramFloat14, paramFloat15, paramFloat16).times(perspectiveTransform);
  }
  ...
  public void transformPoints(float[] paramArrayOffloat) {
    ...
    for (byte b = 0; b < i; b += 2) {
      float f10 = paramArrayOffloat[b];
      int j = b + 1;
      float f11 = paramArrayOffloat[j];
      float f12 = f3 * f10 + f6 * f11 + f9;
      paramArrayOffloat[b] = (f1 * f10 + f4 * f11 + f7) / f12;
      paramArrayOffloat[j] = (f10 * f2 + f11 * f5 + f8) / f12;
    } 
  }
  ...
  public void transformPoints(float[] paramArrayOffloat1, float[] paramArrayOffloat2) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      paramArrayOffloat1[b] = (this.a11 * f1 + this.a21 * f2 + this.a31) / f3;
      paramArrayOffloat2[b] = (this.a12 * f1 + this.a22 * f2 + this.a32) / f3;
    } 
  }
}


/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\zxing\common\PerspectiveTransform.class
