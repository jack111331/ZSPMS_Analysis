...
public final class Version {
  ...
  private Version(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, ECBlocks paramECBlocks) {
    ...
    paramInt4 = paramECBlocks.getECCodewords();
    ECB[] arrayOfECB = paramECBlocks.getECBlocks();
    paramInt3 = arrayOfECB.length;
    paramInt2 = 0;
    paramInt1 = 0;
    while (paramInt2 < paramInt3) {
      ECB eCB = arrayOfECB[paramInt2];
      paramInt1 += eCB.getCount() * (eCB.getDataCodewords() + paramInt4);
      paramInt2++;
    } 
    this.totalCodewords = paramInt1;
  }
  ...
  public static Version getVersionForDimensions(int paramInt1, int paramInt2) throws FormatException {
    if ((paramInt1 & 0x1) == 0 && (paramInt2 & 0x1) == 0) {
      for (Version version : VERSIONS) {
        if (version.symbolSizeRows == paramInt1 && version.symbolSizeColumns == paramInt2)
          return version; 
      } 
  ...
  static final class ECBlocks {
    ...
    private ECBlocks(int param1Int, Version.ECB param1ECB) {
      this.ecCodewords = param1Int;
      this.ecBlocks = new Version.ECB[] { param1ECB };
    }
    
    private ECBlocks(int param1Int, Version.ECB param1ECB1, Version.ECB param1ECB2) {
      this.ecCodewords = param1Int;
      this.ecBlocks = new Version.ECB[] { param1ECB1, param1ECB2 };
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\zxing\datamatrix\decoder\Version.class
