  ...
  public final TypeAdapter<T> nullSafe() {
    return new TypeAdapter<T>() {
        public T read(JsonReader param1JsonReader) throws IOException {
          ...
          return (T)TypeAdapter.this.read(param1JsonReader);
        }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\gson\TypeAdapter.class
