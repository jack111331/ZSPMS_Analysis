...
public final class Gson {
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> paramTypeToken) {
    null = (TypeAdapter)this.typeTokenCache.get(paramTypeToken);
    if (null != null)
      return null; 
    Map<TypeToken<T>, FutureTypeAdapter> map = (Map)this.calls.get();
    null = (FutureTypeAdapter)map.get(paramTypeToken);
    if (null != null)
      return null; 
    ...
    try {
      ...
      while (iterator.hasNext()) {
        null = ((TypeAdapterFactory)iterator.next()).create(this, paramTypeToken);
        if (null != null) {
          futureTypeAdapter.setDelegate(null);
          this.typeTokenCache.put(paramTypeToken, null);
          return null;
        } 
      } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\google\gson\Gson.class
