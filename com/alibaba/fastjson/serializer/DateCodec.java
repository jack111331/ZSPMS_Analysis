  ...
  protected <T> T cast(DefaultJSONParser paramDefaultJSONParser, Type paramType, Object paramObject1, Object paramObject2) {
    ...
    if (paramObject2 instanceof String) {
      ...
      try {
        ...
        paramObject2.close();
        if (paramObject1.length() == date.getDateFomartPattern().length()) {
          DateFormat dateFormat = date.getDateFormat();
          try {
            return (T)dateFormat.parse((String)paramObject1);
          } catch (ParseException parseException) {}
        } 
        Object object = paramObject1;
        return (T)(("0000-00-00".equals(object) || "0000-00-00T00:00:00".equalsIgnoreCase((String)object) || "0001-01-01T00:00:00+08:00".equalsIgnoreCase((String)object)) ? null : new Date(Long.parseLong((String)object)));
      } finally {
        paramObject2.close();
      } 
    } 
  ...
  public void write(JSONSerializer paramJSONSerializer, Object paramObject1, Object paramObject2, Type paramType, int paramInt) throws IOException {
    ...
    if (serializeWriter.isEnabled(SerializerFeature.WriteClassName) && paramObject1.getClass() != dateFormat) {
      if (paramObject1.getClass() == Date.class) {
        ...
        serializeWriter.writeLong(((Date)paramObject1).getTime());
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\alibaba\fastjson\serializer\DateCodec.class
