...
public class JSONArray extends JSON implements List<Object>, Cloneable, RandomAccess, Serializable {
  ...
  public <T> List<T> toJavaList(Class<T> paramClass) {
    ...
    while (iterator.hasNext())
      arrayList.add(TypeUtils.cast(iterator.next(), paramClass, parserConfig)); 
    return arrayList;
  }
}


/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\alibaba\fastjson\JSONArray.class
