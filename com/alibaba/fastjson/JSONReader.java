...
public class JSONReader implements Closeable {
  ...
  public JSONReader(Reader paramReader, Feature... paramVarArgs) {
    this((JSONLexer)new JSONReaderScanner(paramReader));
    int i = paramVarArgs.length;
    for (byte b = 0; b < i; b++)
      config(paramVarArgs[b], true); 
  }
  ...
  public void setLocale(Locale paramLocale) {
    this.parser.lexer.setLocale(paramLocale);
  }
  
  public void setTimzeZone(TimeZone paramTimeZone) {
    this.parser.lexer.setTimeZone(paramTimeZone);
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\alibaba\fastjson\JSONReader.class
