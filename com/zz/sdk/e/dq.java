...
class dq extends AsyncTask {
  ...
  protected static AsyncTask a(t paramt, g paramg, Object paramObject, int paramInt, o paramo) {
    dq dq1 = new dq();
    dq1.execute(new Object[] { paramt, paramg, paramObject, Integer.valueOf(paramInt), paramo });
    return dq1;
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\com\zz\sdk\e\dq.class
