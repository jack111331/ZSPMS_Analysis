...
class ActivityOptionsCompat24 {
  ...
  public static ActivityOptionsCompat24 makeSceneTransitionAnimation(Activity paramActivity, View[] paramArrayOfView, String[] paramArrayOfString) {
    ...
    if (paramArrayOfView != null) {
      ...
      for (byte b = 0; b < arrayOfPair.length; b++)
        arrayOfPair[b] = Pair.create(paramArrayOfView[b], paramArrayOfString[b]); 
    } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\ActivityOptionsCompat24.class
