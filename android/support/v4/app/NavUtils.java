...
public final class NavUtils {
  ...
  static class NavUtilsImplBase implements NavUtilsImpl {
    ...
    public String getParentActivityName(Context param1Context, ActivityInfo param1ActivityInfo) {
      ...
      param1ActivityInfo = activityInfo;
      if (str2 != null) {
        if (str2.charAt(0) == '.')
          return param1Context.getPackageName() + str2; 
        str1 = str2;
      } 
      return str1;
    }
  ...
  static class NavUtilsImplJB extends NavUtilsImplBase {
    public Intent getParentActivityIntent(Activity param1Activity) {
      Intent intent1 = NavUtilsJB.getParentActivityIntent(param1Activity);
      Intent intent2 = intent1;
      if (intent1 == null)
        intent2 = superGetParentActivityIntent(param1Activity); 
      return intent2;
    }
    
    public String getParentActivityName(Context param1Context, ActivityInfo param1ActivityInfo) {
      String str1 = NavUtilsJB.getParentActivityName(param1ActivityInfo);
      String str2 = str1;
      if (str1 == null)
        str2 = super.getParentActivityName(param1Context, param1ActivityInfo); 
      return str2;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\NavUtils.class
