...
class NotificationCompatKitKat {
  public static NotificationCompatBase.Action getAction(Notification paramNotification, int paramInt, NotificationCompatBase.Action$Factory paramAction$Factory, RemoteInputCompatBase.RemoteInput$Factory paramRemoteInput$Factory) {
    ...
    return NotificationCompatJellybean.readAction(paramAction$Factory, paramRemoteInput$Factory, action.icon, action.title, action.actionIntent, bundle);
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\NotificationCompatKitKat.class
