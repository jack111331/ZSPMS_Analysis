...
class NotificationCompatApi20 {
  ...
  public static NotificationCompatBase.Action getAction(Notification paramNotification, int paramInt, NotificationCompatBase.Action$Factory paramAction$Factory, RemoteInputCompatBase.RemoteInput$Factory paramRemoteInput$Factory) {
    return getActionCompatFromAction(paramNotification.actions[paramInt], paramAction$Factory, paramRemoteInput$Factory);
  }
  
  private static NotificationCompatBase.Action getActionCompatFromAction(Notification.Action paramAction, NotificationCompatBase.Action$Factory paramAction$Factory, RemoteInputCompatBase.RemoteInput$Factory paramRemoteInput$Factory) {
    RemoteInputCompatBase.RemoteInput[] arrayOfRemoteInput = RemoteInputCompatApi20.toCompat(paramAction.getRemoteInputs(), paramRemoteInput$Factory);
    boolean bool = paramAction.getExtras().getBoolean("android.support.allowGeneratedReplies");
    return paramAction$Factory.build(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), arrayOfRemoteInput, bool);
  }
  ...
  public static NotificationCompatBase.Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> paramArrayList, NotificationCompatBase.Action$Factory paramAction$Factory, RemoteInputCompatBase.RemoteInput$Factory paramRemoteInput$Factory) {
    ...
    for (byte b = 0; b < arrayOfAction.length; b++)
      arrayOfAction[b] = getActionCompatFromAction((Notification.Action)paramArrayList.get(b), paramAction$Factory, paramRemoteInput$Factory); 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\NotificationCompatApi20.class
