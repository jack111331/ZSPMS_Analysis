  ...
  public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity paramActivity, Pair<View, String>... paramVarArgs) {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      if (paramVarArgs != null) {
        View[] arrayOfView2 = new View[paramVarArgs.length];
        arrayOfString = new String[paramVarArgs.length];
        for (byte b = 0; b < paramVarArgs.length; b++) {
          arrayOfView2[b] = (View)(paramVarArgs[b]).first;
          arrayOfString[b] = (String)(paramVarArgs[b]).second;
        } 
      ...
      return (ActivityOptionsCompat)((Build.VERSION.SDK_INT >= 24) ? new ActivityOptionsImpl24(ActivityOptionsCompat24.makeSceneTransitionAnimation(paramActivity, (View[])arrayOfString1, arrayOfString)) : ((Build.VERSION.SDK_INT >= 23) ? new ActivityOptionsImpl23(ActivityOptionsCompat23.makeSceneTransitionAnimation(paramActivity, (View[])arrayOfString1, arrayOfString)) : new ActivityOptionsImpl21(ActivityOptionsCompat21.makeSceneTransitionAnimation(paramActivity, (View[])arrayOfString1, arrayOfString))));
    } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\ActivityOptionsCompat.class
