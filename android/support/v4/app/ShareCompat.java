  ...
  public static class IntentReader {
    ...
    public Drawable getCallingActivityIcon() {
      ...
      if (this.mCallingActivity != null) {
        ...
        try {
          Drawable drawable1 = packageManager.getActivityIcon(this.mCallingActivity);
          drawable = drawable1;
    ...
    public Drawable getCallingApplicationIcon() {
      ...
      if (this.mCallingPackage != null) {
        PackageManager packageManager = this.mActivity.getPackageManager();
        try {
          Drawable drawable1 = packageManager.getApplicationIcon(this.mCallingPackage);
          drawable = drawable1;
        } catch (android.content.pm.PackageManager.NameNotFoundException nameNotFoundException) {
    ...
    public CharSequence getCallingApplicationLabel() {
      ...
      if (this.mCallingPackage != null) {
        PackageManager packageManager = this.mActivity.getPackageManager();
        try {
          CharSequence charSequence1 = packageManager.getApplicationLabel(packageManager.getApplicationInfo(this.mCallingPackage, 0));
    ...
    public String getHtmlText() {
      ...
      if (charSequence != null)
        str = ShareCompat.IMPL.escapeHtml(charSequence); 
      return str;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\ShareCompat.class
