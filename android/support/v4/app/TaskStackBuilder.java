...
public final class TaskStackBuilder implements Iterable<Intent> {
  ...
  public TaskStackBuilder addParentStack(Activity paramActivity) {
    ...
    Intent intent2 = null;
    if (bool)
      intent2 = ((SupportParentable)paramActivity).getSupportParentActivityIntent(); 
    if (intent2 == null) {
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\TaskStackBuilder.class
