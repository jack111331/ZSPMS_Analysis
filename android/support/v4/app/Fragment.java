...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
  ...
  public static Fragment instantiate(Context paramContext, String paramString, @Nullable Bundle paramBundle) {
    try {
      ...
      Fragment fragment = (Fragment)clazz2.newInstance();
      if (paramBundle != null) {
  ...
  static boolean isSupportFragmentClass(Context paramContext, String paramString) {
    ...
    try {
      ...
      bool = Fragment.class.isAssignableFrom(clazz2);
    } catch (ClassNotFoundException classNotFoundException) {
      bool = false;
    } 
    return bool;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\app\Fragment.class
