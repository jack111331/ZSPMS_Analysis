...
public final class TextDirectionHeuristicsCompat {
  ...
  private static class AnyStrong implements TextDirectionAlgorithm {
    ...
    public int checkRtl(CharSequence param1CharSequence, int param1Int1, int param1Int2) {
      ...
      while (true) {
        int k = j;
        if (k < param1Int1 + param1Int2) {
          switch (TextDirectionHeuristicsCompat.isRtlText(Character.getDirectionality(param1CharSequence.charAt(k)))) {
            case 0:
              if (this.mLookForRtl)
                return 0; 
              j = 1;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\text\TextDirectionHeuristicsCompat.class
