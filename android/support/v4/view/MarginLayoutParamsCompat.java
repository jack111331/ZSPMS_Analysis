...
public final class MarginLayoutParamsCompat {
  ...
  public static int getLayoutDirection(ViewGroup.MarginLayoutParams paramMarginLayoutParams) {
    int i = IMPL.getLayoutDirection(paramMarginLayoutParams);
    int j = i;
    if (i != 0) {
      j = i;
      if (i != 1)
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\MarginLayoutParamsCompat.class
