...
public final class ViewPropertyAnimatorCompat {
  ...
  public Interpolator getInterpolator() {
    null = this.mView.get();
    return (null != null) ? IMPL.getInterpolator(this, null) : null;
  }
  ...
  static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
    ...
    private void postStartMessage(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
      ...
      if (weakHashMap != null)
        runnable2 = this.mStarterMap.get(param1View); 
      Runnable runnable1 = runnable2;
      if (runnable2 == null) {
        runnable1 = new ViewPropertyAnimatorCompat.BaseViewPropertyAnimatorCompatImpl$Starter(param1ViewPropertyAnimatorCompat, param1View);
        if (this.mStarterMap == null)
          this.mStarterMap = new WeakHashMap<View, Runnable>(); 
        this.mStarterMap.put(param1View, runnable1);
      } 
      param1View.removeCallbacks(runnable1);
      param1View.post(runnable1);
    }
    ...
    void startAnimation(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
      ...
      Runnable runnable1 = param1ViewPropertyAnimatorCompat.mStartAction;
      Runnable runnable2 = param1ViewPropertyAnimatorCompat.mEndAction;
      param1ViewPropertyAnimatorCompat.mStartAction = null;
      param1ViewPropertyAnimatorCompat.mEndAction = null;
      if (runnable1 != null)
        runnable1.run(); 
      if (object != null) {
        object.onAnimationStart(param1View);
        object.onAnimationEnd(param1View);
      } 
      if (runnable2 != null)
        runnable2.run(); 
      if (this.mStarterMap != null)
    ...
    class BaseViewPropertyAnimatorCompatImpl$Starter implements Runnable {
      WeakReference<View> mViewRef;
      
      ViewPropertyAnimatorCompat mVpa;
      
      BaseViewPropertyAnimatorCompatImpl$Starter(ViewPropertyAnimatorCompat param2ViewPropertyAnimatorCompat, View param2View) {
  ...
  class BaseViewPropertyAnimatorCompatImpl$Starter implements Runnable {
    ...
    BaseViewPropertyAnimatorCompatImpl$Starter(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View) {
  ...
  static class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
    ...
    public void setListener(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat, View param1View, ViewPropertyAnimatorListener param1ViewPropertyAnimatorListener) {
      param1View.setTag(2113929216, param1ViewPropertyAnimatorListener);
      ViewPropertyAnimatorCompatICS.setListener(param1View, new ViewPropertyAnimatorCompat.ICSViewPropertyAnimatorCompatImpl$MyVpaListener(param1ViewPropertyAnimatorCompat));
    }
    ...
    static class ICSViewPropertyAnimatorCompatImpl$MyVpaListener implements ViewPropertyAnimatorListener {
      boolean mAnimEndCalled;
      
      ViewPropertyAnimatorCompat mVpa;
      
      ICSViewPropertyAnimatorCompatImpl$MyVpaListener(ViewPropertyAnimatorCompat param2ViewPropertyAnimatorCompat) {
        this.mVpa = param2ViewPropertyAnimatorCompat;
      }
      ...
      public void onAnimationCancel(View param2View) {
        ...
        if (object != null)
          object.onAnimationCancel(param2View); 
      }
      ...
      public void onAnimationEnd(View param2View) {
        ...
        if (Build.VERSION.SDK_INT >= 16 || !this.mAnimEndCalled) {
          ...
          if (object != null)
            object.onAnimationEnd(param2View); 
      ...
      public void onAnimationStart(View param2View) {
        ...
        if (object != null)
          object.onAnimationStart(param2View); 
      }
    }
  }
  ...
  static class ICSViewPropertyAnimatorCompatImpl$MyVpaListener implements ViewPropertyAnimatorListener {
    ...
    ICSViewPropertyAnimatorCompatImpl$MyVpaListener(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat) {
      this.mVpa = param1ViewPropertyAnimatorCompat;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\ViewPropertyAnimatorCompat.class
