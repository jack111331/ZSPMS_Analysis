...
class PathInterpolatorGingerbread implements Interpolator {
  ...
  public float getInterpolation(float paramFloat) {
    ...
    if (paramFloat < 1.0F) {
      ...
      return f * (this.mY[j] - paramFloat) + paramFloat;
    } 
    return 1.0F;
  }
}
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\animation\PathInterpolatorGingerbread.class
