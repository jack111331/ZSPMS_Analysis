  ...
  static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
    ...
    private static int metaStateFilterDirectionalModifiers(int param1Int1, int param1Int2, int param1Int3, int param1Int4, int param1Int5) {
      ...
      if (bool2) {
        ...
        return param1Int1 & (param1Int5 ^ 0xFFFFFFFF);
      } 
      param1Int2 = param1Int1;
      if (param1Int4 != 0)
        param1Int2 = param1Int1 & (param1Int3 ^ 0xFFFFFFFF); 
      return param1Int2;
    }
    ...
    public boolean metaStateHasModifiers(int param1Int1, int param1Int2) {
      boolean bool = true;
      if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(param1Int1) & 0xF7, param1Int2, 1, 64, 128), param1Int2, 2, 16, 32) != param1Int2)
        bool = false; 
      return bool;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\KeyEventCompat.class
