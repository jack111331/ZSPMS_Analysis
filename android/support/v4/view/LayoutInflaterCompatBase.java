...
class LayoutInflaterCompatBase {
  static LayoutInflaterFactory getFactory(LayoutInflater paramLayoutInflater) {
    null = paramLayoutInflater.getFactory();
    return (null instanceof FactoryWrapper) ? ((FactoryWrapper)null).mDelegateFactory : null;
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\LayoutInflaterCompatBase.class
