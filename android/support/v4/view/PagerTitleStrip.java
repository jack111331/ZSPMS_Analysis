...
public class PagerTitleStrip extends ViewGroup {
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    paramInt1 = getChildMeasureSpec(paramInt1, (int)(0.2F * k), -2);
    ...
    if (View.MeasureSpec.getMode(paramInt2) == 1073741824) {
      ...
      paramInt1 = Math.max(getMinHeight(), i + paramInt1);
    } 
    setMeasuredDimension(k, ViewCompat.resolveSizeAndState(paramInt1, paramInt2, ViewCompat.getMeasuredState((View)this.mCurrText) << 16));
  }
  ...
  public void setTextColor(@ColorInt int paramInt) {
    ...
    paramInt = this.mNonPrimaryAlpha << 24 | 0xFFFFFF & this.mTextColor;
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    if (f1 > 1.0F)
      f2 = f1 - 1.0F; 
    m = n - i5 - (int)(f2 * (n - i2 + m - i5)) - j / 2;
    j = m + j;
    int i6 = this.mPrevText.getBaseline();
    int i7 = this.mCurrText.getBaseline();
    i5 = this.mNextText.getBaseline();
    int i8 = Math.max(Math.max(i6, i7), i5);
    i6 = i8 - i6;
    i7 = i8 - i7;
    i5 = i8 - i5;
    ...
    i8 = Math.max(Math.max(i9 + i6, i8 + i7), i10 + i5);
    switch (this.mGravity & 0x70) {
      default:
        ...
        this.mPrevText.layout(i4, i1, i + i4, this.mPrevText.getMeasuredHeight() + i1);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\view\PagerTitleStrip.class
