...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
  ...
  final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable {
    ...
    protected D doInBackground(Void... param1VarArgs) {
      try {
        param1VarArgs = AsyncTaskLoader.this.onLoadInBackground();
      } catch (OperationCanceledException operationCanceledException) {}
      return (D)operationCanceledException;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\content\AsyncTaskLoader.class
