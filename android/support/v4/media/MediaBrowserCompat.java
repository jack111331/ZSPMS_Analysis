...
public final class MediaBrowserCompat {
  ...
  public static class ConnectionCallback {
    ...
    void setInternalConnectionCallback(MediaBrowserCompat.ConnectionCallback$ConnectionCallbackInternal param1ConnectionCallback$ConnectionCallbackInternal) {
      this.mConnectionCallbackInternal = param1ConnectionCallback$ConnectionCallbackInternal;
    }
    ...
    private class ConnectionCallback$StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
      public void onConnected() {
  ...
  public static abstract class ItemCallback {
    ...
    private class ItemCallback$StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
  ...
  static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
    ...
    public void connect() {
      ...
      final MediaBrowserCompat.MediaBrowserImplBase$MediaServiceConnection thisConnection = new MediaBrowserCompat.MediaBrowserImplBase$MediaServiceConnection();
      this.mServiceConnection = mediaBrowserImplBase$MediaServiceConnection;
      try {
        bool = this.mContext.bindService(intent, this.mServiceConnection, 1);
    ...
    public void subscribe(@NonNull String param1String, Bundle param1Bundle, @NonNull MediaBrowserCompat.SubscriptionCallback param1SubscriptionCallback) {
      ...
      subscription.putCallback(param1Bundle, param1SubscriptionCallback);
      if (this.mState == 2)
        try {
          this.mServiceBinderWrapper.addSubscription(param1String, param1SubscriptionCallback.mToken, param1Bundle, this.mCallbacksMessenger);
        } catch (RemoteException remoteException) {
    ...
    private class MediaBrowserImplBase$MediaServiceConnection implements ServiceConnection {
  ...
  private static class ServiceBinderWrapper {
    ...
    void addSubscription(String param1String, IBinder param1IBinder, Bundle param1Bundle, Messenger param1Messenger) {
    ...
    void connect(Context param1Context, Messenger param1Messenger) {
      Bundle bundle = new Bundle();
    ...
    void disconnect(Messenger param1Messenger) {
      sendRequest(2, null, param1Messenger);
    }
    
    void getMediaItem(String param1String, ResultReceiver param1ResultReceiver, Messenger param1Messenger) {
      Bundle bundle = new Bundle();
      bundle.putString("data_media_item_id", param1String);
    ...
    void registerCallbackMessenger(Messenger param1Messenger) {
      Bundle bundle = new Bundle();
      bundle.putBundle("data_root_hints", this.mRootHints);
      sendRequest(6, bundle, param1Messenger);
    }
    
    void removeSubscription(String param1String, IBinder param1IBinder, Messenger param1Messenger) {
      Bundle bundle = new Bundle();
      bundle.putString("data_media_item_id", param1String);
      BundleCompat.putBinder(bundle, "data_callback_token", param1IBinder);
    ...
    void search(String param1String, Bundle param1Bundle, ResultReceiver param1ResultReceiver, Messenger param1Messenger) {
      Bundle bundle = new Bundle();
    ...
    void unregisterCallbackMessenger(Messenger param1Messenger) {
  ...
  public static abstract class SubscriptionCallback {
    ...
    private class SubscriptionCallback$StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
    ...
    private class SubscriptionCallback$StubApi24 extends MediaBrowserCompat.SubscriptionCallback$StubApi21 implements MediaBrowserCompatApi24.SubscriptionCallback {
  ...
  private class SubscriptionCallback$StubApi24 extends SubscriptionCallback$StubApi21 implements MediaBrowserCompatApi24.SubscriptionCallback {
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\media\MediaBrowserCompat.class
