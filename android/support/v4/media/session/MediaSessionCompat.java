...
public class MediaSessionCompat {
  ...
  public static abstract class Callback {
    ...
    private class Callback$StubApi21 implements MediaSessionCompatApi21.Callback {
      public void onCommand(String param2String, Bundle param2Bundle, ResultReceiver param2ResultReceiver) {
        ...
        if (bundle.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
          mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
          MediaSessionCompat.Callback.this.onAddQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
          return;
        } 
        if (bundle.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
          mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
          MediaSessionCompat.Callback.this.onAddQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"), mediaSessionImplApi21.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX"));
          return;
        } 
        if (bundle.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM")) {
          mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
          MediaSessionCompat.Callback.this.onRemoveQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
          return;
        } 
        if (bundle.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT")) {
          MediaSessionCompat.Callback.this.onRemoveQueueItemAt(mediaSessionImplApi21.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX"));
          return;
        } 
    ...
    private class Callback$StubApi23 extends MediaSessionCompat.Callback$StubApi21 implements MediaSessionCompatApi23.Callback {
      Callback$StubApi23() {
    ...
    private class Callback$StubApi24 extends MediaSessionCompat.Callback$StubApi23 implements MediaSessionCompatApi24.Callback {
      Callback$StubApi24() {
        super(MediaSessionCompat.Callback.this);
      }
  ...
  private class Callback$StubApi21 implements MediaSessionCompatApi21.Callback {
    public void onCommand(String param1String, Bundle param1Bundle, ResultReceiver param1ResultReceiver) {
      ...
      if (bundle.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
        mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
        this.this$0.onAddQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
        return;
      } 
      if (bundle.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
        mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
        this.this$0.onAddQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"), mediaSessionImplApi21.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX"));
        return;
      } 
      if (bundle.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM")) {
        mediaSessionImplApi21.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
        this.this$0.onRemoveQueueItem((MediaDescriptionCompat)mediaSessionImplApi21.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
        return;
      } 
      if (bundle.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT")) {
        this.this$0.onRemoveQueueItemAt(mediaSessionImplApi21.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX"));
        return;
      } 
  ...
  private class Callback$StubApi23 extends Callback$StubApi21 implements MediaSessionCompatApi23.Callback {
    public void onPlayFromUri(Uri param1Uri, Bundle param1Bundle) {
      this.this$0.onPlayFromUri(param1Uri, param1Bundle);
    }
  }
  
  private class Callback$StubApi24 extends Callback$StubApi23 implements MediaSessionCompatApi24.Callback {
    public void onPrepare() {
      this.this$0.onPrepare();
    }
  ...
  static class MediaSessionImplApi21 implements MediaSessionImpl {
    ...
    MediaSessionCompat.MediaSessionImplApi21$ExtraSession getExtraSessionBinder() {
      if (this.mExtraSessionBinder == null)
        this.mExtraSessionBinder = new MediaSessionCompat.MediaSessionImplApi21$ExtraSession(); 
  ...
  static class MediaSessionImplBase implements MediaSessionImpl {
    ...
    PlaybackStateCompat getStateWithUpdatedPosition() {
      ...
      //   135: lcmp
      //   136: ifle -> 194
      //   139: new android/support/v4/media/session/PlaybackStateCompat$Builder
      //   142: dup
      //   143: aload #4
      //   145: invokespecial <init> : (Landroid/support/v4/media/session/PlaybackStateCompat;)V
      //   148: astore_3
      //   149: aload_3
      //   150: aload #4
      ...
      //   155: lload #5
      //   157: aload #4
      //   159: invokevirtual getPlaybackSpeed : ()F
      //   162: lload #7
      //   164: invokevirtual setState : (IJFJ)Landroid/support/v4/media/session/PlaybackStateCompat$Builder;
      //   167: pop
      //   168: aload_3
    ...
    public void setCallback(MediaSessionCompat.Callback param1Callback, Handler param1Handler) {
      ...
      if (param1Handler == null)
        null = new Handler(); 
      synchronized (this.mLock) {
        MediaSessionCompat.MediaSessionImplBase$MessageHandler mediaSessionImplBase$MessageHandler = new MediaSessionCompat.MediaSessionImplBase$MessageHandler();
        this(this, null.getLooper());
        this.mHandler = mediaSessionImplBase$MessageHandler;
    ...
    private static final class MediaSessionImplBase$Command {
      ...
      public MediaSessionImplBase$Command(String param2String, Bundle param2Bundle, ResultReceiver param2ResultReceiver) {
      ...
      public ParcelableVolumeInfo getVolumeAttributes() {
        ...
        synchronized (MediaSessionCompat.MediaSessionImplBase.this.mLock) {
          ...
          if (j == 2) {
            ...
            return new ParcelableVolumeInfo(j, k, i, i1, i2);
          } 
    ...
    private class MediaSessionImplBase$MessageHandler extends Handler {
      ...
      public MediaSessionImplBase$MessageHandler(Looper param2Looper) {
        super(param2Looper);
      }
      ...
      public void handleMessage(Message param2Message) {
        MediaSessionCompat.MediaSessionImplBase$Command mediaSessionImplBase$Command;
        Intent intent;
        KeyEvent keyEvent;
        ...
        switch (param2Message.what) {
          default:
            return;
          case 1:
            mediaSessionImplBase$Command = (MediaSessionCompat.MediaSessionImplBase$Command)param2Message.obj;
            callback.onCommand(mediaSessionImplBase$Command.command, mediaSessionImplBase$Command.extras, mediaSessionImplBase$Command.stub);
          case 21:
            keyEvent = (KeyEvent)((Message)mediaSessionImplBase$Command).obj;
          ...
          case 25:
            callback.onAddQueueItem((MediaDescriptionCompat)((Message)intent).obj);
          case 26:
            callback.onAddQueueItem((MediaDescriptionCompat)((Message)intent).obj, ((Message)intent).arg1);
          case 27:
            callback.onRemoveQueueItem((MediaDescriptionCompat)((Message)intent).obj);
          case 28:
            callback.onRemoveQueueItemAt(((Message)intent).arg1);
          case 2:
            MediaSessionCompat.MediaSessionImplBase.this.adjustVolume(((Message)intent).arg1, 0);
          case 22:
            MediaSessionCompat.MediaSessionImplBase.this.setVolumeTo(((Message)intent).arg1, 0);
          case 23:
            callback.onSetRepeatMode(((Message)intent).arg1);
          case 24:
            break;
        } 
        callback.onSetShuffleModeEnabled(((Boolean)((Message)intent).obj).booleanValue());
      }
  ...
  private static final class MediaSessionImplBase$Command {
    ...
    public MediaSessionImplBase$Command(String param1String, Bundle param1Bundle, ResultReceiver param1ResultReceiver) {
  ...
  class MediaSessionImplBase$MediaSessionStub extends IMediaSession.Stub {
    ...
    public ParcelableVolumeInfo getVolumeAttributes() {
      int i = 2;
      synchronized (this.this$0.mLock) {
        int j = this.this$0.mVolumeType;
        int k = this.this$0.mLocalStream;
        ...
        int m = this.this$0.mAudioManager.getStreamMaxVolume(k);
        int n = this.this$0.mAudioManager.getStreamVolume(k);
        return new ParcelableVolumeInfo(j, k, i, m, n);
      } 
    }
  ...
  private class MediaSessionImplBase$MessageHandler extends Handler {
    ...
    public MediaSessionImplBase$MessageHandler(Looper param1Looper) {
      super(param1Looper);
    }
    ...
    public void handleMessage(Message param1Message) {
      ...
      switch (param1Message.what) {
        default:
          return;
        case 1:
          mediaSessionImplBase$Command = (MediaSessionCompat.MediaSessionImplBase$Command)param1Message.obj;
          callback.onCommand(mediaSessionImplBase$Command.command, mediaSessionImplBase$Command.extras, mediaSessionImplBase$Command.stub);
        case 21:
          keyEvent = (KeyEvent)((Message)mediaSessionImplBase$Command).obj;
          intent = new Intent("android.intent.action.MEDIA_BUTTON");
        ...
        case 22:
          this.this$0.setVolumeTo(((Message)intent).arg1, 0);
        case 23:
          callback.onSetRepeatMode(((Message)intent).arg1);
        case 24:
          break;
      ...
      if (this != param1Object) {
        ...
        if (param1Object instanceof Token) {
          ...
          if (this.mInner == null) {
            ...
            bool1 = bool;
            if (((Token)param1Object).mInner != null)
              bool1 = this.mInner.equals(((Token)param1Object).mInner); 
            return bool1;
          } 
        } else {
          return bool1;
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
