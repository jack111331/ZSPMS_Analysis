...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject) {
    ...
    if (list != null) {
      bundle = (Bundle)new ArrayList(list.size());
      Iterator iterator = list.iterator();
      while (true) {
        arrayList = (ArrayList<CustomAction>)bundle;
        if (iterator.hasNext()) {
          bundle.add(CustomAction.fromCustomAction(iterator.next()));
          continue;
        } 
        break;
      } 
    ...
    PlaybackStateCompat playbackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), arrayList, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), bundle);
  ...
  public Object getPlaybackState() {
    ...
    List<CustomAction> list1 = null;
    if (list2 != null) {
      list2 = new ArrayList<CustomAction>(this.mCustomActions.size());
    ...
    if (Build.VERSION.SDK_INT >= 22) {
      this.mStateObj = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)list1, this.mActiveItemId, this.mExtras);
    } else {
      this.mStateObj = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)list1, this.mActiveItemId);
    } 
    return this.mStateObj;
  }
  ...
  public static final class CustomAction implements Parcelable {
    ...
    public static final class CustomAction$Builder {
      ...
      public CustomAction$Builder(String param2String, CharSequence param2CharSequence, int param2Int) {
      ...
      public CustomAction$Builder setExtras(Bundle param2Bundle) {
  ...
  public static final class CustomAction$Builder {
    ...
    public CustomAction$Builder(String param1String, CharSequence param1CharSequence, int param1Int) {
    ...
    public CustomAction$Builder setExtras(Bundle param1Bundle) {
      this.mExtras = param1Bundle;
      return this;
    }
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\media\session\PlaybackStateCompat.class
