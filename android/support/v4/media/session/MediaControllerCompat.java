...
public final class MediaControllerCompat {
  ...
  public static abstract class Callback implements IBinder.DeathRecipient {
    ...
    private void setHandler(Handler param1Handler) {
      this.mHandler = new MediaControllerCompat.Callback$MessageHandler(param1Handler.getLooper());
    }
    ...
    private class Callback$MessageHandler extends Handler {
      ...
      public Callback$MessageHandler(Looper param2Looper) {
        super(param2Looper);
      }
    ...
    private class Callback$StubApi21 implements MediaControllerCompatApi21.Callback {
  ...
  private class Callback$MessageHandler extends Handler {
    ...
    public Callback$MessageHandler(Looper param1Looper) {
      super(param1Looper);
    }
  ...
  static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        synchronized (this.mPendingCallbacks) {
          ...
          while (true) {
            if (iterator.hasNext()) {
              ...
              MediaControllerCompat.MediaControllerImplApi21$ExtraCallback mediaControllerImplApi21$ExtraCallback = new MediaControllerCompat.MediaControllerImplApi21$ExtraCallback();
              this(this, callback);
    ...
    public final void registerCallback(MediaControllerCompat.Callback param1Callback, Handler param1Handler) {
      MediaControllerCompat.MediaControllerImplApi21$ExtraCallback mediaControllerImplApi21$ExtraCallback;
      ...
      if (this.mExtraBinder != null) {
        ...
        mediaControllerImplApi21$ExtraCallback = new MediaControllerCompat.MediaControllerImplApi21$ExtraCallback(param1Callback);
        this.mCallbackMap.put(param1Callback, mediaControllerImplApi21$ExtraCallback);
      ...
      null.setHandler((Handler)mediaControllerImplApi21$ExtraCallback);
      synchronized (this.mPendingCallbacks) {
    ...
    public final void unregisterCallback(MediaControllerCompat.Callback param1Callback) {
      ...
      if (this.mExtraBinder != null) {
        try {
          MediaControllerCompat.MediaControllerImplApi21$ExtraCallback mediaControllerImplApi21$ExtraCallback = this.mCallbackMap.remove(param1Callback);
          if (mediaControllerImplApi21$ExtraCallback != null)
    ...
    private static class MediaControllerImplApi21$ExtraBinderRequestResultReceiver extends ResultReceiver {
      ...
      public MediaControllerImplApi21$ExtraBinderRequestResultReceiver(MediaControllerCompat.MediaControllerImplApi21 param2MediaControllerImplApi21, Handler param2Handler) {
        super(param2Handler);
    ...
    private class MediaControllerImplApi21$ExtraCallback extends IMediaControllerCallback.Stub {
      ...
      MediaControllerImplApi21$ExtraCallback(MediaControllerCompat.Callback param2Callback) {
  ...
  private static class MediaControllerImplApi21$ExtraBinderRequestResultReceiver extends ResultReceiver {
    ...
    public MediaControllerImplApi21$ExtraBinderRequestResultReceiver(MediaControllerCompat.MediaControllerImplApi21 param1MediaControllerImplApi21, Handler param1Handler) {
      super(param1Handler);
  ...
  private class MediaControllerImplApi21$ExtraCallback extends IMediaControllerCallback.Stub {
    ...
    MediaControllerImplApi21$ExtraCallback(MediaControllerCompat.Callback param1Callback) {
  ...
  static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
    public MediaControllerImplApi23(Context param1Context, MediaSessionCompat.Token param1Token) {
  ...
  static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
    public MediaControllerImplApi24(Context param1Context, MediaSessionCompat.Token param1Token) {
      super(param1Context, param1Token);
    }
  ...
  static class MediaControllerImplBase implements MediaControllerImpl {
    ...
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      try {
        if ((0x4L & this.mBinder.getFlags()) == 0L) {
    ...
    public int getRepeatMode() {
      boolean bool;
      try {
        bool = this.mBinder.getRepeatMode();
      } catch (RemoteException remoteException) {
        Log.e("MediaControllerCompat", "Dead object in getRepeatMode.", (Throwable)remoteException);
        bool = false;
      } 
    ...
    public boolean isShuffleModeEnabled() {
      boolean bool;
      try {
        bool = this.mBinder.isShuffleModeEnabled();
      } catch (RemoteException remoteException) {
        Log.e("MediaControllerCompat", "Dead object in isShuffleModeEnabled.", (Throwable)remoteException);
        bool = false;
      } 
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
