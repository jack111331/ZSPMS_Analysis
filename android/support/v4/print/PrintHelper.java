...
public final class PrintHelper {
  ...
  private static class PrintHelperImpl<RealHelper extends PrintHelperKitkat> implements PrintHelperVersionImpl {
    ...
    public void printBitmap(String param1String, Uri param1Uri, final PrintHelper.OnPrintFinishCallback callback) {
      PrintHelperKitkat.OnPrintFinishCallback onPrintFinishCallback = null;
      if (callback != null)
        onPrintFinishCallback = new PrintHelperKitkat.OnPrintFinishCallback() {
            public void onFinish() {
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\print\PrintHelper.class
