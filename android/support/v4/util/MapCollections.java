...
abstract class MapCollections<K, V> {
  ...
  public <T> T[] toArrayHelper(T[] paramArrayOfT, int paramInt) {
    ...
    for (byte b = 0; b < i; b++)
      paramArrayOfT[b] = (T)colGetEntry(b, paramInt); 
    if (paramArrayOfT.length > i)
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v\\util\MapCollections.class
