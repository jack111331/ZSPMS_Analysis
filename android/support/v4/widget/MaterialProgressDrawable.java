...
class MaterialProgressDrawable extends Drawable implements Animatable {
  ...
  private int evaluateColorChange(float paramFloat, int paramInt1, int paramInt2) {
    ...
    paramInt1 = i >> 8 & 0xFF;
    i &= 0xFF;
    int m = Integer.valueOf(paramInt2).intValue();
    paramInt2 = (int)(((m >> 24 & 0xFF) - j) * paramFloat);
    int n = (int)(((m >> 16 & 0xFF) - k) * paramFloat);
    int i1 = (int)(((m >> 8 & 0xFF) - paramInt1) * paramFloat);
    return i + (int)(((m & 0xFF) - i) * paramFloat) | j + paramInt2 << 24 | k + n << 16 | i1 + paramInt1 << 8;
  }
  ...
  private void setSizeParameters(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, float paramFloat1, float paramFloat2) {
    ...
    ring.setArrowDimensions(paramFloat1 * f, f * paramFloat2);
    ...
    Animation animation = new Animation() {
        public void applyTransformation(float param1Float, Transformation param1Transformation) {
          ...
          if (param1Float <= 0.5F) {
            ...
            ring.setStartTrim(f3 + f * (0.8F - f1));
          } 
          if (param1Float > 0.5F) {
            f3 = (param1Float - 0.5F) / 0.5F;
            f3 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f3);
            ring.setEndTrim((0.8F - f1) * f3 + f2);
          } 
          ring.setRotation(0.25F * param1Float + f4);
          f2 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
          MaterialProgressDrawable.this.setRotation(216.0F * param1Float + 1080.0F * f2);
        }
      };
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\MaterialProgressDrawable.class
