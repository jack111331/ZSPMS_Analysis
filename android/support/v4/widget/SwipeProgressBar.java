  ...
  void draw(Canvas paramCanvas) {
    ...
    if (this.mRunning || this.mFinishTime > 0L) {
      ...
      if (!this.mRunning) {
        ...
        f1 = (i / 2) * INTERPOLATOR.getInterpolation(f1);
        this.mClipRect.set(k - f1, 0.0F, f1 + k, j);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\SwipeProgressBar.class
