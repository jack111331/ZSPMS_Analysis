  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect paramRect) {
    ...
    if (getChildCount() != 0) {
      ...
      if (paramRect.bottom > i && paramRect.top > n) {
        ...
        return Math.min(n, getChildAt(0).getBottom() - i);
      } 
  ...
  public void draw(Canvas paramCanvas) {
    ...
    if (this.mEdgeGlowTop != null) {
      ...
      if (!this.mEdgeGlowBottom.isFinished()) {
        ...
        int j = getHeight();
        paramCanvas.translate((-m + getPaddingLeft()), (Math.max(getScrollRange(), i) + j));
        paramCanvas.rotate(180.0F, m, 0.0F);
        this.mEdgeGlowBottom.setSize(m, j);
    ...
    switch (i) {
      ...
      case 2:
        ...
        if (j == -1) {
          ...
          i = m;
          if (dispatchNestedPreScroll(0, m, this.mScrollConsumed, this.mScrollOffset)) {
      ...
      if (!super.performAccessibilityAction(param1View, param1Int, param1Bundle)) {
        ...
        switch (param1Int) {
          default:
            return false;
          case 4096:
            param1Int = Math.min(nestedScrollView.getHeight() - nestedScrollView.getPaddingBottom() - nestedScrollView.getPaddingTop() + nestedScrollView.getScrollY(), nestedScrollView.getScrollRange());
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
