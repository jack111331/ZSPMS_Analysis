...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
  ...
  private void moveSpinner(float paramFloat) {
    ...
    this.mProgress.setProgressRotation(0.5F * (f2 * 0.4F - 0.25F + f3 * 2.0F));
  ...
  public void onNestedPreScroll(View paramView, int paramInt1, int paramInt2, int[] paramArrayOfint) {
    ...
    if (dispatchNestedPreScroll(paramInt1 - paramArrayOfint[0], paramInt2 - paramArrayOfint[1], arrayOfInt, (int[])null)) {
      ...
      paramArrayOfint[1] = arrayOfInt[1] + paramInt1;
    } 
  }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
