...
class TextViewCompatGingerbread {
  ...
  private static int retrieveIntFromField(Field paramField, TextView paramTextView) {
    byte b;
    try {
      b = paramField.getInt(paramTextView);
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\TextViewCompatGingerbread.class
