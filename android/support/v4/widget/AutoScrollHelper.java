...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    f1 = this.mMinimumVelocity[paramInt];
    paramFloat2 = this.mMaximumVelocity[paramInt];
    paramFloat3 = f2 * paramFloat3;
    return (paramFloat1 > 0.0F) ? constrain(paramFloat1 * paramFloat3, f1, paramFloat2) : -constrain(-paramFloat1 * paramFloat3, f1, paramFloat2);
  }
  ...
  private float getEdgeValue(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {
    ...
    if (paramFloat2 < 0.0F) {
      paramFloat1 = -this.mEdgeInterpolator.getInterpolation(-paramFloat2);
    } else {
      paramFloat1 = f;
      if (paramFloat2 > 0.0F) {
        paramFloat1 = this.mEdgeInterpolator.getInterpolation(paramFloat2);
  ...
  private static class ClampedScroller {
    ...
    private float getValueAt(long param1Long) {
      ...
      if (param1Long >= this.mStartTime) {
        ...
        f = AutoScrollHelper.constrain((float)(param1Long - l) / this.mEffectiveRampDown, 0.0F, 1.0F) * f1 + 1.0F - f;
      } 
      return f;
    }
...
/* Location:              D:\Code\Crack\dex-tools-2.1-20190905-lanchon\zspns-pcgw-P36417A-0429-dex2jar.jar!\android\support\v4\widget\AutoScrollHelper.class
